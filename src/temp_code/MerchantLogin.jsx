...
export default function MerchantAuthForm() {
  ...
  const [username, setUsername] = useState("merchantbiz");
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 text-white bg-gray-800">
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        >
          <button
            type="button"
            className="w-full flex items-center justify-center border border-white/30 py-2.5 rounded-full hover:bg-white/10 transition font-medium"
          >
